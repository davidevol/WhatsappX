...
import com.davidev.whatsappx.adapter.GrupoSelecionadoAdapter;
...
public class CadastroGrupoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabSalvarGrupo.setOnClickListener(v -> {
        ...
        if (resultCode == RESULT_OK) {
            ...
            try {
                ...
                if (imagem != null) {
                    ...
                    // Recupera os dados da imagem para o firebase
                    ...
                    uploadTask.addOnFailureListener(e -> Toast.makeText(CadastroGrupoActivity.this,
